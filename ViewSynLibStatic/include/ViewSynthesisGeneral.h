...
public:
	...
	*/
	...
	Sample* GetInterpolatedLeft() { return m_pcViewSynthesisLeft; }
	Sample* GetInterpolatedRight() { return m_pcViewSynthesisRight; }
...
private:
	...
	Sample*  m_pcViewSynthesisLeft;
	Sample*  m_pcViewSynthesisRight;
