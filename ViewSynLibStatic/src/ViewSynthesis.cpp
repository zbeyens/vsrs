...
void ViewSynthesis::initInputImages()
{
	...
	m_pcDepthMapLeft = new CIYuv<DepthType>(srcHeight, srcWidth, DEPTHMAP_CHROMA_FORMAT);
	m_pcDepthMapRight = new CIYuv<DepthType>(srcHeight, srcWidth, DEPTHMAP_CHROMA_FORMAT);
	...
	m_pcImageLeft = new CIYuv<ImageType>(mHeight, mWidth, IMAGE_CHROMA_FORMAT);
	m_pcImageRight = new CIYuv<ImageType>(mHeight, mWidth, IMAGE_CHROMA_FORMAT);

	// why?
	if (cfg.getPrecision() != 1)
	{
		m_pcTempYuvLeft = new CIYuv<ImageType>(srcHeight, srcWidth, IMAGE_CHROMA_FORMAT);
		m_pcTempYuvRight = new CIYuv<ImageType>(srcHeight, srcWidth, IMAGE_CHROMA_FORMAT);
	}
	else
	{
...
bool ViewSynthesis::SetReferenceImage(int iLeft, CIYuv<ImageType> *pcYuv)
{
#ifdef _DEBUG
...
bool ViewSynthesis::DoViewInterpolation(CIYuv<ImageType>* pSynYuvBuffer)
{
	/*
...
bool ViewSynthesis::xViewSynthesisGeneralMode(CIYuv<ImageType>* pSynYuvBuffer)
{
	ImageType*** RefLeft = m_pcImageLeft->getData();
	ImageType*** RefRight = m_pcImageRight->getData();
	DepthType** RefDepthLeft = m_pcDepthMapLeft->Y;
 ...
 *    false: if fails.
 */
bool ViewSynthesis::xViewSynthesis1DMode(CIYuv<ImageType>* pSynYuvBuffer)
{
...
bool ViewSynthesis::xBoundaryNoiseRemoval(CIYuv<ImageType>* pRefLeft, CIYuv<ImageType>* pRefRight, CIYuv<DepthType>* pRefDepthLeft, CIYuv<DepthType>* pRefDepthRight, CIYuv<HoleType>* pRefHoleLeft, CIYuv<HoleType>* pRefHoleRight, CIYuv<ImageType>* pSynYuvBuffer, bool SynthesisMode)
{
...
void ViewSynthesis::xFileConvertingforGeneralMode(CIYuv<ImageType>* pRefLeft, CIYuv<ImageType>* pRefRight, CIYuv<DepthType>* pRefDepthLeft, CIYuv<DepthType>* pRefDepthRight, CIYuv<HoleType>* pRefHoleLeft, CIYuv<HoleType>* pRefHoleRight)
{
	int Width, Height;
...
void ViewSynthesis::xFileConvertingfor1DMode(CIYuv<ImageType>* pRefLeft, CIYuv<ImageType>* pRefRight, CIYuv<DepthType>* pRefDepthLeft, CIYuv<DepthType>* pRefDepthRight, CIYuv<HoleType>* pRefHoleLeft, CIYuv<HoleType>* pRefHoleRight)
{
