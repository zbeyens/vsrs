...
bool BoundaryNoiseRemoval::DoBoundaryNoiseRemoval(ImageYuv<ImageType>* pRefLeft, ImageYuv<ImageType>* pRefRight, ImageYuv<DepthType>* pRefDepthLeft, ImageYuv<DepthType>* pRefDepthRight, 
                           ImageYuv<HoleType>* pRefHoleLeft, ImageYuv<HoleType>* pRefHoleRight, ImageYuv<ImageType>* pSynYuvBuffer, bool SynhtesisMode)
{
...
void BoundaryNoiseRemoval::RemainingHoleFilling_General(ImageYuv<ImageType>* pSrc)
{
...
void BoundaryNoiseRemoval::RemainingHoleFilling_1DMode(ImageYuv<ImageType>* pSrc)
{
  int i, j, tWidth, tHeight, CountHole;
...
void BoundaryNoiseRemoval::Blending(ImageYuv<ImageType>* pLeft,ImageYuv<ImageType>* pRight, ImageYuv<ImageType>* pSyn, bool SynhtesisMode)
{
  int i, j;
  ...
  ImageYuv<ImageType> temp1, temp2;
  IplImage *TempImage;
...
void BoundaryNoiseRemoval::HoleFillingWithExpandedHole(ImageYuv<ImageType>* pSrc, ImageYuv<ImageType>* pTar, IplImage* m_imgExpandedHole, bool SynthesisMode)
{
...
void BoundaryNoiseRemoval::copyImages(ImageYuv<ImageType>* pSyn_CurrView, ImageYuv<DepthType>* pSynDepth_CurrView, ImageYuv<HoleType>* pSynHole_CurrView, ImageYuv<HoleType>* pDepthHole_OthView)
{
...
void BoundaryNoiseRemoval::ColorFillingSmallHoleFor1DMode(ImageYuv<ImageType>* pSrc, ImageYuv<ImageType>* pDst) 
{
...
void BoundaryNoiseRemoval::ColorHoleCleaning(ImageYuv<ImageType>* pSrc)
{
  int i, j, tWidth, tHeight;
...
void BoundaryNoiseRemoval::DepthFillingSmallHoleFor1DMode(ImageYuv<DepthType>* pSrc, ImageYuv<DepthType>* pDst) 
{
  int tWidth, tHeight,i, j;
  bool isAvailableLeft, isAvailableRight, isAvailableCurrent;
...
void BoundaryNoiseRemoval::DepthMatchingWithColor(ImageYuv<DepthType>* pDepth, ImageYuv<ImageType>* pColor, ImageYuv<HoleType>* pDepthMask)
{
  int i, j, width, height;
