...
public:
	...
	bool    DoBoundaryNoiseRemoval(ImageYuv<ImageType>* pRefLeft, ImageYuv<ImageType>* pRefRight, ImageYuv<DepthType>* pRefDepthLeft, ImageYuv<DepthType>* pRefDepthRight, ImageYuv<HoleType>* pRefHoleLeft, ImageYuv<HoleType>* pRefHoleRight, ImageYuv<ImageType>* pSynYuvBuffer, bool SynhtesisMode);
	void    xInit() ;
...
//#ifdef POZNAN_GENERAL_HOMOGRAPHY
  ...
  void copyImages                    (ImageYuv<ImageType>* pSyn_CurrView, ImageYuv<DepthType>* pSynDepth_CurrView, ImageYuv<HoleType>* pSynHole_CurrView, ImageYuv<HoleType>* pDepthHole_OthView);
	...
	void HoleFillingWithExpandedHole   (ImageYuv<ImageType>* pSrc,   ImageYuv<ImageType>* pTar,   IplImage* m_imgExpandedHole, bool SynthesisMode);
	void Blending                      (ImageYuv<ImageType>* pLeft,  ImageYuv<ImageType>* pRight, ImageYuv<ImageType>* pSyn, bool SynthesisMode);
	void ColorFillingSmallHoleFor1DMode(ImageYuv<ImageType>* pSrc,   ImageYuv<ImageType>* pDst);
	void DepthFillingSmallHoleFor1DMode(ImageYuv<DepthType>* pSrc,   ImageYuv<DepthType>* pDst);
	void DepthMatchingWithColor        (ImageYuv<DepthType>* pDepth, ImageYuv<ImageType>* pColor, ImageYuv<HoleType>* pDepthMask);
	void ColorHoleCleaning             (ImageYuv<ImageType>* pSrc);	
  void RemainingHoleFilling_General  (ImageYuv<ImageType>* pSrc);
  void RemainingHoleFilling_1DMode   (ImageYuv<ImageType>* pSrc);
