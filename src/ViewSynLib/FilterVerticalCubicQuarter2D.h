...
class FilterVerticalCubicQuarter2D : public Filter<PixelType>
{
public:
	FilterVerticalCubicQuarter2D()
	{
	}
...
template<class PixelType>
inline void FilterVerticalCubicQuarter2D<PixelType>::apply(PixelType ** in, PixelType ** out, int width, int height, int padding_size)
{
	int i, ipel[4], opel[4];
